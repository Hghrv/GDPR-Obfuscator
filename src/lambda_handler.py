...
def lambda_handler(event, context='aws_context'):
    ...
    file_key = body.get('file_to_obfuscate',
                        'new_data/test_file.csv')  # Access event keys
    ...
    try:
        ...
        upload_to_ouput_s3(bucket_name_output,
                           output_key_json, bytestream_output_json)
        ...
        upload_to_ouput_s3(bucket_name_output,
                           output_key_parquet, bytestream_output_parquet)
